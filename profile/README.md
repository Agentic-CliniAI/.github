...
* 🔍 **MedF2Route** — 基于证据路由的幻觉检测方法 [`MedF2Route`](https://github.com/Agentic-CliniAI/MedF2Route)

* 🛡️ **MedFH** — 基于逻辑线索树的幻觉检测和幻觉校准方法 [`MedFH`](https://github.com/Agentic-CliniAI/MedFH)
